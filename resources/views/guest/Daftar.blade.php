...
<body>
    <div class="flex flex-col lg:flex-row lg:justify-between h-full">
        ...
        <img class="w-full h-48 sm:h-80 object-cover lg:w-1/3 lg:h-auto" 
            ...
            <form id="registerForm" action="{{ route('pengguna.store') }}" method="POST" class="w-full px-4 lg:px-0 mt-2 sm:mt-5 lg:mt-0 lg:max-w-md">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="nama" name="nama" class="bg-gray-100 border border-Border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="John Doe" required />
                    </div>
                    <div>
                        <label for="email" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Email</label>
                        <input type="email" id="email" name="email" class="bg-gray-100 border border-Border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="john.doe@company.com" required />
                    </div>
                </div>
                <div class="mb-6">
                    <label for="no_telepon" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">No Telepon</label>
                    <input type="number" id="no_telepon" name="no_telepon" class="bg-gray-100 border border-Border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="08123300220" required />
                </div>
                <div class="mb-6">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div class="lg:mb-3">
                        ...
                        <div class="relative">
                            <input type="password" id="kata_sandi" name="kata_sandi" class="bg-gray-100 border border-Border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-10" placeholder="•••••••••" required />
                    ...
                    <div class="lg:mb-3">
                        ...
                        <div class="relative">
                            <input type="password" id="confirm_kata_sandi" name="confirm_kata_sandi" class="bg-gray-100 border border-Border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-10" placeholder="•••••••••" required />
