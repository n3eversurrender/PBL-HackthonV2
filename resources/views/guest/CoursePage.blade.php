...
<div class=" grid grid-cols-3 gap-4 mt-8 pr-8">
  ...
  <div class=" pl-8 ">
    <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
      ...
      <div class=" grid grid-cols-3 gap-1 mt-2 mb-4">
        ...
        <div>
          <button class=" border-2 rounded-lg p-2  text-gray-500 "> tembesi</button>
        </div>
        <div>
      ...
      <div class="">
        ...
        <a href="#" class="text-xl font-bold leading-tight text-gray-900 hover:underline mb-2 ">Beginner's welding</a>
        <p href="#" class="text-base mb-2 leading-tight text-gray-900 hover:underline my-2 ">10 trainees already enrolled</p>
        ...
        <h2 class="mb-2 font-semibold text-gray-900 dark:text-white text-sm  pt-4">Course include</h2>
  ...
  <div class="col-span-2 text-wrap pr-5 pl-8">
    ...
    <div class=" mb-4 bg-gray-200 rounded-md w-full py-6">
      <h2 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white pl-8 mt-4">in this course, u will learn:</h2>
    ...
    <div class="mt-4">
      <div id="accordion-open" data-accordion="open" class="w-full max-w-4xl mx-auto">
        <!-- Accordion Header -->
        <h2 id="accordion-open-heading-1">
          <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800">
            <span class="font-bold">Trainee Review and Feedback</span>

          </button>
        </h2>

        <!-- Review 1 -->
        <div class="flex items-start justify-between w-full p-5 border-2 border-gray-200">
          <!-- Profile & Name -->
          <div class="flex items-center w-1/2">
            <div class="w-12 h-12 bg-gray-300 rounded-full mr-4"></div>
            <div>
              <p class="font-bold text-blue-600 hover:underline">Donald Trump</p>
              <p class="text-gray-600">Et eligendi expedita. Accusantium qui est eius nemo eaque dolore necessitatibus voluptatem...</p>
            </div>
          </div>
          <!-- Rating -->
        ...
        <!-- Review 2 -->
        <div class="flex items-start justify-between w-full p-5 border-2 rounded-b-lg border-gray-600">
          <!-- Profile & Name -->
          <div class="flex items-center w-1/2">
            <div class="w-12 h-12 bg-gray-300 rounded-full mr-4"></div>
            <div>
              <p class="font-bold text-blue-600 hover:underline">Kamala Harris</p>
              <p class="text-gray-600">Et eligendi expedita. Accusantium qui est eius nemo eaque dolore necessitatibus voluptatem...</p>
            </div>
          </div>
          <!-- Rating -->
