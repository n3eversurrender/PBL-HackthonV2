...
<section>
    ...
    <div class="my-5">
        <div class="bg-gwhite text-center p-6">
            <button type="button" class="px-5 py-2.5 text-md font-medium text-white" style="background-color: #337DC1; border-radius: 0.375rem;">Uncover What We Provide</button>
            <div>
                <p class="mt-5 font-bold text-3xl">The Complete Platform for Welding and Fabrication Mastery</p>
                <span class="text-sm text-[#0F172A] w-1/3">
                    Join our premier platform that connects you with top-rated mentors in welding and fabrication. Track your progress in real-time and receive personalized insights tailored to your learning needs. With advanced AI technology, our platform offers customized recommendations to help you sharpen your skills effectively. Whether you're a beginner or looking to enhance your expertise, you'll benefit from structured training and valuable feedback to excel in the fabrication industry. All this is accessible in one user-friendly platform designed for your success.
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-4">
        <div class="bg-white text-center p-6">
            ...
            <p class="text-2xl font-semibold text-[#0F172A]">Skill Improvement</p>
            <span class="text-sm text-[#0F172A] w-1/3">Unlock your potential with hands-on learning and expert guidance to continuously enhance your skill set</span>
        </div>
        ...
        <div class="bg-white text-center p-6">
            ...
            <p class="text-2xl font-semibold text-[#0F172A]">Tracking Your Progress</p>
            <span class="text-sm text-[#0F172A] w-1/3">Monitor your achievements in real-time with our intuitive tools that help you stay on top of your goals </span>
        </div>
        ...
        <div class="bg-white text-center p-6">
            ...
            <p class="text-2xl font-semibold text-[#0F172A]">Top Rated Mentor</p>
            <span class="text-sm text-[#0F172A] w-1/3">Learn from the best in the field, with access to mentors rated highly by students for their expertise and teaching </span>
        </div>
        ...
        <div class="bg-white text-center p-6">
            ...
            <p class="text-2xl font-semibold text-[#0F172A]">Ai Suggestion</p>
            <span class="text-sm text-[#0F172A] w-1/3">Get personalized recommendations powered by AI to optimize your learning journey and improve performance </span>
        </div>
    </div>
</section>

<div class="mt-10" style="background-color: #F8FAFC;">
    <div class="text-center mb-16">
        <h2 class="text-3xl font-bold mb-3 pt-10">Learn from Top-Rated Experts</h2>
        <span class="text-sm text-[#0F172A] w-1/3">Gain hands-on experience and industry insights from mentors who are trusted and highly rated by learners like you.</span>
    </div>
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-full">
                ...
                <div class="px-4 pb-4">
                    ...
                    <div class="flex items-center justify-center">
                        <a href="#" class="w-32 bg-[#337DC1] rounded-lg text-white font-medium text-sm px-4 py-1.5 text-center transition duration-300 ease-in-out hover:bg-[#2A6B9B]">View Detail</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="my-10 text-center">
    <h2 class="text-3xl font-bold">Lead the Way as a Mentor</h2>
    <span class="text-sm text-[#0F172A] w-1/3">Help shape the future by guiding aspiring learners. Become a mentor, share your knowledge, and inspire the next generation of skilled professionals.</span>
</div>
        ...
        <div class="w-full h-96 p-2"> <!-- Card dengan lebar penuh dan tinggi 96 -->
            <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-full overflow-hidden"> <!-- Menambahkan overflow-hidden untuk memastikan rounding bekerja -->
                <div class="relative h-full"> <!-- Menjaga tinggi tetap dan menempatkan gambar di dalam -->
                    ...
                    <div class="absolute left-24 bottom-1/2 transform translate-y-1/2"> <!-- Mengatur posisi tombol dan teks di kiri tengah -->
                        <p class="text-white text-2xl font-bold mb-5">BECOME MENTOR</p> <!-- Teks di atas tombol dengan warna putih -->
                        <a href="#" class="bg-[#337DC1] rounded-lg text-white font-medium text-center px-4 py-2">Start a course today</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container mx-auto p-4">
    <div class="flex">
        <div class="w-1/2 p-4">
            ...
            <span class="text-sm text-[#0F172A] w-1/3">Our FAQ section offers quick answers about our welding courses, covering topics like duration, certification, and required materials. For anything else, feel free to contact us!</span>
        </div>
        <div class="w-1/2 p-4 ">
...
<div style="background-color: #F8FAFC;">
    <div class="container flex justify-between mb-5">
        <div class="text-2xl font-bold w-1/4 ml-10 mt-10">
    ...
    <div class="pb-10">
        <div class="flex justify-center items-center space-x-14">
            <article class="w-96 h-auto p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
