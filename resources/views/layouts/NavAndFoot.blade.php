...
<body class="w-full">
    ...
    <!-- Navbar + Image -->
    <nav class="bg-black bg-opacity-50 border-gray-200 dark:bg-black dark:bg-opacity-50 fixed w-full z-10 top-0">
        <div class="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                ...
                <button type="button" id="login-button" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" onclick="window.location.href='/Masuk';">
                    Masuk
                </button>
                @endif
            </div>
            ...
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-500 rounded-lg bg-gray-400 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-transparent md:dark:bg-transparent dark:border-gray-700">
                    <li>
                        <a href="/Home"
                            class="{{ request()->is('Home') ? 'border-b-2 border-blue-700 text-blue-700 font-bold' : 'text-white' }} block py-2 px-3 rounded md:border-0 md:p-0 hover:text-blue-500">
                            Beranda
                        </a>
                    </li>
                    <li>
                        <a href="/TentangKami"
                            class="{{ request()->is('TentangKami') ? 'border-b-2 border-blue-700 text-blue-700 font-bold' : 'text-white' }} block py-2 px-3 rounded md:border-0 md:p-0 hover:text-blue-500">
                            Tentang Kami
                        </a>
                    </li>
                    <li>
                        <a href="/DaftarKursus"
                            class="{{ request()->is('DaftarKursus') ? 'border-b-2 border-blue-700 text-blue-700 font-bold' : 'text-white' }} block py-2 px-3 rounded md:border-0 md:p-0 hover:text-blue-500">
                            Kursus
                        </a>
                    </li>
                </ul>
