...
<section class="bg-white dark:bg-gray-900">
  <form action="" class="pb-2 pt-2 px-4">
    <!-- photo start -->
      <div class=" flex mb-2">
        <div>
    ...
    <div class="flex justify-end w-full">
        <button type="button" class=" text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-md text-sm px-10 py-1.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Save</button>
    </div>
