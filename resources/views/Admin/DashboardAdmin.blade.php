        ...
        <div class="flex justify-between border-gray-200 border-b dark:border-gray-700 pb-3">
            <dl>
                ...
                <dd class="leading-none text-2xl font-bold text-gray-900 dark:text-white">
                    Rp {{ number_format($totalPembayaran, 0, ',', '.') }} <!-- Menampilkan total pembayaran -->
                </dd>
            </dl>
            <div>
                <span class="bg-green-100 text-green-800 text-xs font-medium inline-flex items-center px-2.5 py-1 rounded-md dark:bg-green-900 dark:text-green-300">
                    ...
                    <!-- Menampilkan pertumbuhan (growth) -->
                    @if ($growth > 0)
                    <span class="text-green-500">Profit rate {{ number_format($growth, 2) }}%</span> <!-- Jika pertumbuhan positif -->
                    @elseif ($growth < 0)
                        <span class="text-red-500">Profit rate {{ number_format(abs($growth), 2) }}%</span> <!-- Jika pertumbuhan negatif -->
                @else
                <span class="text-gray-500">Profit rate 0%</span> <!-- Jika tidak ada pertumbuhan -->
                @endif
                </span>
            </div>
        ...
        <div class="grid grid-cols-2 py-3">
            <dl>
                ...
                <dd class="leading-none text-xl font-bold text-green-500 dark:text-green-400">
                    Rp {{ number_format($totalPemasukanKemarin, 0, ',', '.') }} <!-- Format Rupiah --> </dd>
            </dl>
            <dl>
                <dt class="text-base font-normal text-gray-500 dark:text-gray-400 pb-1">Pemasukan Sekarang</dt>
                <dd class="leading-none text-xl font-bold text-green-500 dark:text-green-400">
                    Rp {{ number_format($totalPemasukanHariIni, 0, ',', '.') }} <!-- Format Rupiah --> </dd>
            </dl>
        </div>
    </div>
</div>
