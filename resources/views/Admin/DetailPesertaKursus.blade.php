...
<section>
    ...
    <form class="flex justify-end">   
        <label for="default-search" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Search Peserta</label>
        <div class="relative">
    ...
    <!-- search end -->
    <h1 class="ms-3 mb-3 text-2xl font-bold">Welding</h1>
    <!-- tabel start -->
    ...
    <ul class="flex justify-end items-center -space-x-px h-8 text-sm mt-8">
        <li>
