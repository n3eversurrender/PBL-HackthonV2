...
<div class="flex items-start">
    <figure class="max-w-96">
        <img class="h-auto max-w-96 rounded-lg" src="{{ asset('image/12.webp') }}" alt="image description">
        <figcaption class="mt-2 text-sm text-center text-gray-500 dark:text-gray-400">Image caption</figcaption>
    </figure>
    <div class="ml-4"> <!-- Tambahkan div untuk mengelompokkan h1 dan p -->
        <h1 class="text-2xl font-bold">Welding Master</h1>
        <p class="mt-2 text-sm text-gray-600">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Exercitationem, odit labore ad eos consequatur tempora sunt dolorum voluptatum culpa in, rerum ullam omnis soluta error tempore laborum voluptate provident? Possimus?</p> <!-- Deskripsi di bawah h1 -->
    </div>
</div>
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                    <img class="w-10 h-10 rounded-full" src="{{ asset('image/9203764.png') }}" alt="Jese image">
                    <div class="ps-3">
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <div class="flex items-center">
                        <div class="h-2.5 w-2.5 me-2"></div> Punggur
                    </div>
                </td>
                <td class="px-6 py-4">
                    <div class="flex items-center">
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <div class="flex items-center">
                        <div class="h-2.5 w-2.5 me-2"></div> Sekupang
                    </div>
                </td>
                <td class="px-6 py-4">
                    <div class="flex items-center">
